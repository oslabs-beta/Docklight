  ...
  return (
    <div className="flex flex-col bg-base-200 dark:bg-base-100 items-center text-3xl font-bold underlined w-[375px] max-w-[425px] shadow-lg">
      ...
      <div className='flex h-screen flex-col space-y-8 text-center mt-[150px]'>
        ...
        <Link to="/YourContainers"className='btn btn-primary hover:bg-secondary hover:border-secondary text-white text-[20px] font-medium py-2 px-4 drop-shadow-md rounded' ><button className=''>Your Containers</button></Link>
        <Link to="/Team" className='btn btn-primary hover:bg-secondary hover:border-secondary text-white text-[20px] font-medium py-2 px-4 drop-shadow-md rounded'> <button className=''>Team</button></Link>
      </div>
